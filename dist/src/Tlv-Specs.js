...
describe('Tlv', function () {
    describe('deserialize', function () {
        ...
        it('can parse 1 byte tag primitve tlv object', function () {
            ...
            result = Tlv_1.TlvFactory.parseVerbose(buffer);
            items = result.result;
